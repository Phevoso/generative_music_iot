...
ip_adress="localhost"
client_name="roker.hivemq.com"
mqtt_topic="sensors"
mongo_client_key="insert personal client key"

python3 /home/pi/generative-music-iot/python/LANToMQTT/readSensorData.py -i $ip_adress -c $client_name -t $mqtt_topic -m $mongo_client_key &